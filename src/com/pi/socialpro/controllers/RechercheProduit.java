 ...
 * @author Navoxx
 */
public class RechercheProduit extends AffichageFormU {
    
    
    
    private Resources theme;
    
      public void getAllU(String tg) {
        AffichageFormU hii = new AffichageFormU();
    /*    SpanLabel sp = new SpanLabel("");
        hii.add(sp);*/

        
           hii.getToolbar().addMaterialCommandToSideMenu("Liste des produits", 
...
FontImage searchIcon = FontImage.createMaterial(FontImage.MATERIAL_SEARCH, s);
   ...
   // <4>
        ...
        con.setUrl("http://localhost/php/rech.php?typeproduit="+tg);
...
x="file://"+t.getPath();
                    ...
                    fab.addActionListener(new ActionListener() {
                       ...
                       iduser = Login.userCon.getId();
                            for (Produit x : getListProduitF(new String(con.getResponseData()))) {
                            req.setUrl("http://localhost/php/insertPanier.php?produit=" + x.getId() +"&user="+iduser+ "");
