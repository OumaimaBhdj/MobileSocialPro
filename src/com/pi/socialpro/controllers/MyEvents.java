...
public class MyEvents {
    ...
    public MyEvents(Resources theme) {
...
//        f = ui.createContainer(theme, "EventsList").getComponentForm();
    ...
    public void start() {
        f = new Form("Mes évènements", BoxLayout.y());
        ConnectionRequest req = new ConnectionRequest();
        
        req.setUrl("http://localhost/socialpromobile/selectmyevents.php?iduser="+Login.userCon.getId());
        // req.setUrl("http://localhost/socialpromobile/partevents.php?iduser="+SignInForm.userCon.getId());
