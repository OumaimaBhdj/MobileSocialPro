...
import com.pi.socialpro.RechercheForm;
 ...
 * @author Navoxx
 */
public class RecherchePublication {
    ...
    SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
     ...
     public void Recherche(String s){
        RechercheForm hi = new RechercheForm();
...
Button back =new Button();
    ...
    FontImage backIcon= FontImage.createMaterial(FontImage.MATERIAL_ARROW_BACK,s1);
    ...
    hi.getToolbar().addCommandToLeftBar("",backIcon,(e)->{new AffichagePublication().getAll();});
        ...
        con.setUrl("http://localhost/php/recherche.php?username="+s);
